...
/*******************************
 posElemDicionario - Consulta a posição ocupada no dicionario pelo elemento com a chave dada.
Parametros:
	d – dicionario
	ch – endereço da chave do elemento
Retorno: retorna a posição ocupada, e -1, caso contrario
...
/***********************************************
incDicionario - Duplica o tamanho do vetor dicionario
Parametros:
	d – dicionario	
Retorno: 
Pre-condicoes: d != NULL 
